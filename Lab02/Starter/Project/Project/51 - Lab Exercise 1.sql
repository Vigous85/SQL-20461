...
-- Task 1
-- 
-- Using SQL Server Management Studio (SSMS), connect to MIA-SQL using Windows authentication (if you are connecting to an on-premises instance of SQL Server).
--
-- Create and populate database TSQL:
--    For on-premise, database TSQL is already created and populated in the VM so no further steps are needed. 
--
